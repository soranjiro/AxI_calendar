...
// FeatureExecutionResult defines model for FeatureExecutionResult.
type FeatureExecutionResult struct {
	// EndDate The end date used for the feature execution
	EndDate openapi_types.Date `json:"end_date"`

	// FeatureName The name of the executed feature
	FeatureName string `json:"feature_name"`

	// Result The result of the feature execution, type depends on the feature
	Result FeatureExecutionResult_Result `json:"result"`

	// StartDate The start date used for the feature execution
	StartDate openapi_types.Date `json:"start_date"`

	// ThemeId The ID of the theme the feature was executed on
	ThemeId openapi_types.UUID `json:"theme_id"`
}

// FeatureExecutionResultResult0 Count result for count feature
type FeatureExecutionResultResult0 = int

// FeatureExecutionResultResult1 Numeric result for aggregation features
type FeatureExecutionResultResult1 = float32

// FeatureExecutionResultResult2 Complex result object for advanced features
type FeatureExecutionResultResult2 = map[string]interface{}

// FeatureExecutionResult_Result The result of the feature execution, type depends on the feature
type FeatureExecutionResult_Result struct {
...
// GetThemesThemeIdFeaturesFeatureNameParams defines parameters for GetThemesThemeIdFeaturesFeatureName.
type GetThemesThemeIdFeaturesFeatureNameParams struct {
	// StartDate Start date for the feature execution (optional, defaults to 30 days ago)
	StartDate *openapi_types.Date `form:"start_date,omitempty" json:"start_date,omitempty"`

	// EndDate End date for the feature execution (optional, defaults to today)
...
// AsFeatureExecutionResultResult0 returns the union data inside the FeatureExecutionResult_Result as a FeatureExecutionResultResult0
func (t FeatureExecutionResult_Result) AsFeatureExecutionResultResult0() (FeatureExecutionResultResult0, error) {
	var body FeatureExecutionResultResult0
	err := json.Unmarshal(t.union, &body)
	return body, err
}

// FromFeatureExecutionResultResult0 overwrites any union data inside the FeatureExecutionResult_Result as the provided FeatureExecutionResultResult0
func (t *FeatureExecutionResult_Result) FromFeatureExecutionResultResult0(v FeatureExecutionResultResult0) error {
	b, err := json.Marshal(v)
	t.union = b
	return err
}

// MergeFeatureExecutionResultResult0 performs a merge with any union data inside the FeatureExecutionResult_Result, using the provided FeatureExecutionResultResult0
func (t *FeatureExecutionResult_Result) MergeFeatureExecutionResultResult0(v FeatureExecutionResultResult0) error {
	b, err := json.Marshal(v)
	if err != nil {
		return err
	}
...
// AsFeatureExecutionResultResult1 returns the union data inside the FeatureExecutionResult_Result as a FeatureExecutionResultResult1
func (t FeatureExecutionResult_Result) AsFeatureExecutionResultResult1() (FeatureExecutionResultResult1, error) {
	var body FeatureExecutionResultResult1
	err := json.Unmarshal(t.union, &body)
	return body, err
}

// FromFeatureExecutionResultResult1 overwrites any union data inside the FeatureExecutionResult_Result as the provided FeatureExecutionResultResult1
func (t *FeatureExecutionResult_Result) FromFeatureExecutionResultResult1(v FeatureExecutionResultResult1) error {
	b, err := json.Marshal(v)
	t.union = b
	return err
}

// MergeFeatureExecutionResultResult1 performs a merge with any union data inside the FeatureExecutionResult_Result, using the provided FeatureExecutionResultResult1
func (t *FeatureExecutionResult_Result) MergeFeatureExecutionResultResult1(v FeatureExecutionResultResult1) error {
	b, err := json.Marshal(v)
	if err != nil {
		return err
	}
...
// AsFeatureExecutionResultResult2 returns the union data inside the FeatureExecutionResult_Result as a FeatureExecutionResultResult2
func (t FeatureExecutionResult_Result) AsFeatureExecutionResultResult2() (FeatureExecutionResultResult2, error) {
	var body FeatureExecutionResultResult2
	err := json.Unmarshal(t.union, &body)
	return body, err
}

// FromFeatureExecutionResultResult2 overwrites any union data inside the FeatureExecutionResult_Result as the provided FeatureExecutionResultResult2
func (t *FeatureExecutionResult_Result) FromFeatureExecutionResultResult2(v FeatureExecutionResultResult2) error {
	b, err := json.Marshal(v)
	t.union = b
	return err
}

// MergeFeatureExecutionResultResult2 performs a merge with any union data inside the FeatureExecutionResult_Result, using the provided FeatureExecutionResultResult2
func (t *FeatureExecutionResult_Result) MergeFeatureExecutionResultResult2(v FeatureExecutionResultResult2) error {
	b, err := json.Marshal(v)
	if err != nil {
		return err
	}
...
func (t FeatureExecutionResult_Result) MarshalJSON() ([]byte, error) {
	b, err := t.union.MarshalJSON()
	return b, err
}

func (t *FeatureExecutionResult_Result) UnmarshalJSON(b []byte) error {
...
type ServerInterface interface {
	...
	ExecuteFeature(ctx echo.Context, themeId ThemeIdParam, featureName FeatureNameParam, params GetThemesThemeIdFeaturesFeatureNameParams) error
}
...
// ExecuteFeature converts echo context to params.
func (w *ServerInterfaceWrapper) ExecuteFeature(ctx echo.Context) error {
	var err error
	// ------------- Path parameter "theme_id" -------------
	var themeId ThemeIdParam
	...
	// Parameter object where we will unmarshal all parameters from the context
	var params GetThemesThemeIdFeaturesFeatureNameParams
	...
	// Invoke the callback with all the unmarshaled arguments
	err = w.Handler.GetThemesThemeIdFeaturesFeatureName(ctx, themeId, featureName, params)
	return err
}
